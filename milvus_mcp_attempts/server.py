...
try:
    ...
    logging.info("Custom modules imported")
    ...
    import traceback
    logging.info("Exception during import:")
    traceback.print_exc()
    exit(1)
...
if __name__ == "__main__":
    logging.info("Launching Milvus MCP server...")
    ...
    try:
        ...
        logging.info(f"  MILVUS_URI = {os.environ.get('MILVUS_URI')}")
        logging.info(f"  MILVUS_TOKEN = {os.environ.get('MILVUS_TOKEN')}")
        logging.info(f"  MILVUS_DB = {os.environ.get('MILVUS_DB')}")
